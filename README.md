...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;background:linear-gradient(180deg,#fff,var(--bg));color:var(--text)}
    ...
    .title{font-weight:700;font-size:18px;display:flex;align-items:center;gap:10px}.title .dot{width:10px;height:10px;border-radius:50%;background:#1976d2;display:inline-block}
  ...
  <dialog id="dlg">
    ...
    <div class="dialog-body">
      <form id="form" class="grid grid-3">
        ...
        <label>Első észlelés<br><input type="date" name="elsoEszleles"></label>
